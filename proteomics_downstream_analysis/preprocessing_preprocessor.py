...
class Preprocessing:
    ...
    def filter_for_valid_vals_in_one_exp_group(self):
    ...
    def impute_genes_with_protein_ids(self):
    ...
    def impute_based_on_gaussian(self):
    ...
    def filter_for_valid_vals_perc(self, percentage):
    ...
    def filter_for_valid_vals_in_one_exp_group_perc(self, percentage):
...
class Preprocessor:
    ...
    def _process(self, data):
        ...
        self.data = self._preprocessing.change_datatypes(data)
        
        # log2 transform data
        self.data = self._preprocessing.log2_transform()
        
        # filter for valid values in at least one experimental group
        self.data = self._preprocessing.filter_for_valid_vals_in_one_exp_group()
        
        # impute genes data
        self.data = self._preprocessing.impute_genes_with_protein_ids()
        
        # impute data based on normal distribution
        self.data = self._preprocessing.impute_based_on_gaussian()
